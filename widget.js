  ...
  profileForm.addEventListener("submit", async (e) => {
    ...
    try {
      const response = await fetch("https://script.google.com/macros/s/AKfycbwUz5jbUKLkEUN9Ge_enyKdPdW1V_T4C3QHwtJxkxsqxSyHuntsgZuA05x3eHotGz96Mw/exec", {
        ...
        // Note: Removing the custom Content-Type header to prevent a preflight request
        body: JSON.stringify(formObject)
      });
      
      // With no-cors mode the response is opaque. We assume success if no error is thrown.
